...
type MdxFieldsFilterInput = {
  readonly slug: InputMaybe<StringQueryOperatorInput>;
  readonly tagSlugs: InputMaybe<StringQueryOperatorInput>;
};
...
type IndexPageQuery = { readonly allMdx: { readonly edges: ReadonlyArray<{ readonly node: { readonly rawBody: string, readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly title: string, readonly subtitle: string | null, readonly date: string | null } | null } }> } };

type NotesPageQueryVariables = Exact<{ [key: string]: never; }>;


type NotesPageQuery = { readonly allMdx: { readonly edges: ReadonlyArray<{ readonly node: { readonly body: string, readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly title: string, readonly date: string | null } | null } }> } };
...
type TagPageQuery = { readonly allMdx: { readonly totalCount: number, readonly edges: ReadonlyArray<{ readonly node: { readonly body: string, readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly title: string, readonly subtitle: string | null, readonly date: string | null } | null } }> } };

type RefBySlugQueryVariables = Exact<{
  slug: Scalars['String'];
}>;


type RefBySlugQuery = { readonly mdx: { readonly body: string, readonly fields: { readonly tagSlugs: ReadonlyArray<string | null> | null } | null, readonly frontmatter: { readonly title: string, readonly subtitle: string | null, readonly tags: ReadonlyArray<string | null> | null, readonly date: string | null, readonly draft: boolean | null } | null } | null };
...
type BlogPostTemplateQuery = { readonly mdx: { readonly body: string, readonly fields: { readonly slug: string | null, readonly tagSlugs: ReadonlyArray<string | null> | null } | null, readonly frontmatter: { readonly title: string, readonly subtitle: string | null, readonly tags: ReadonlyArray<string | null> | null, readonly date: string | null, readonly draft: boolean | null } | null } | null };
...
type Unnamed_1_Query = { readonly allMdx: { readonly edges: ReadonlyArray<{ readonly node: { readonly fileAbsolutePath: string, readonly frontmatter: { readonly tags: ReadonlyArray<string | null> | null, readonly layout: string | null } | null } }> } };
